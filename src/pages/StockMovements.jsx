...
function StockMovements() {
  ...
  const [form, setForm] = useState({ productId: '', supplierId: '', quantity: '', note: '' })
  ...
  return (
    <Layout>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold mb-1" style={{ color: '#0f172a' }}>Stock Movements</h1>
          <p className="text-sm" style={{ color: '#94a3b8' }}>{movements.length} total movements</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bg-white rounded-xl p-5 flex items-center gap-4"
          ...
          <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
            ...
            <MdArrowDownward size={22} className="text-white" />
          </div>
          <div>
            <p className="text-xs font-medium mb-1" style={{ color: '#94a3b8' }}>Total Stock IN</p>
            <p className="text-2xl font-bold" style={{ color: '#0f172a' }}>{totalIn.toLocaleString()}</p>
          </div>
        </div>
        <div className="bg-white rounded-xl p-5 flex items-center gap-4"
          style={{ border: '1px solid #f1f5f9', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
          <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
            ...
            <MdArrowUpward size={22} className="text-white" />
          </div>
          <div>
            <p className="text-xs font-medium mb-1" style={{ color: '#94a3b8' }}>Total Stock OUT</p>
            <p className="text-2xl font-bold" style={{ color: '#0f172a' }}>{totalOut.toLocaleString()}</p>
          </div>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
          ...
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl">
            ...
            <div className="flex items-center justify-between px-6 py-4"
              ...
              <div>
                <h2 className="text-lg font-bold" style={{ color: '#0f172a' }}>Restock Product</h2>
